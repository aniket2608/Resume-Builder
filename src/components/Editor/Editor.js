...
function Editor(props) {
    ...
    <div className={styles.detail}>
      ...
      <div className={styles.row}>
        ...
        <InputControl
          ...
          onChange={(event) =>
            setValues((prev) => ({ ...prev, location: event.target.value.trim() }))
          }
        />
        {values.location === 'Remote' && <span>(Remote)</span>}
      </div>
      <div className={styles.row}>
        <InputControl
          label="Start Date"
  ...
  const basicInfoBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Name"
          placeholder="Enter your full name eg. Aniket"
          value={values.name}
          onChange={(event) =>
    ...
    switch (sections[activeSectionKey]) {
      ...
      case sections.workExp: {
        const tempDetail = {
          ...
          location: values.location.trim(), // Trim the location value
  ...
  const handleNextSection = () => {
    ...
    setActiveSectionKey(sectionKeys[nextIndex]);
  };
